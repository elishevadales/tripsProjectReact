  ...
  const onClickSearch = async () => {
    ...
    try {
      ...
      if (resp.data[0]) {
        ...
        setCenter([resp.data[0].lat, resp.data[0].lon]);
      } else {
      ...
      <div className="border shadow p-3 d-flex align-items-center flex-column">
        ...
        {isLocationFound ? (
          <div className="border shadow col-12 mt-4 d-flex">
            <div className="col-8 p-3 d-flex justify-content-between align-items-center">
              <div className="left">
                ...
                <div className="h6">
                  ...
                  <p>
                    {locationData.address.city &&
                      "עיר: " + locationData.address.city}
                  </p>
                  <p>
                    {" "}
                    {locationData.address.road &&
                      "רחוב: " + locationData.address.road}{" "}
