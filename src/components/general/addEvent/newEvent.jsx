...
const NewEvent = () => {
  ...
  const nameRef = register("event_name", {
    required: "יש להזין שם לאירוע",
    minLength: { value: 2, message: "יש להזין לפחות 2 תווים" },
    maxLength: { value: 30, message: "יש להזין עד 30 תווים" },
  });
  const categoryRef = register("category", { required: "יש לבחור קטגוריה" });
  const subCategoryRef = register("sub_category", {
    minLength: 0,
    maxLength: 100,
  });
  const freeRef = register("free", {
    required: "יש לסמן חינם/בתשלום",
  });
  const adultPriceRef = register("adult", { min: 0, max: 10000 });
  const studentOrSoldierPriceRef = register("studentOrSoldier", {
    min: 0,
    max: 10000,
  });
  ...
  const tripDetailsRef = register("trip_details", {
    minLength: 2,
    maxLength: 1000,
  });
  ...
  const duringRef = register("during", {
    minLength: { value: 2, message: "יש להזין לפחות 2 תווים" },
    maxLength: { value: 300, message: "יש להזין עד 300 תווים" },
    required: "יש לפרט מה הצפי למשך הטיול",
  });
  const requiredEquipmentRef = register("required_equipment", {
    minLength: 2,
    maxLength: 300,
  });
  ...
  return (
    <section className="py-4">
      ...
      <div className="container h-100 ">
        <div className="pt-4">
          <div
            className="col-12 d-flex align-items-center justify-content-center display-3"
            style={{
              height: "300px",
              backgroundImage: `url(${require("../../../images/addEvent.jpg")})`,
          ...
          <div
            className="col-12 m-0  p-2 p-sm-4 bg-white py-3"
            style={{ boxShadow: "-4px 7px 13px -2px rgba(0,0,0,0.75)" }}
          >
            <form onSubmit={handleSubmit(onSub)} className="mx-1 mx-md-4">
                ...
                <div className="form-outline flex-fill mb-0">
                  ...
                  <fieldset className="mb-3">
                    ...
                    <div>
                      ...
                      <label
                        className="form-check-label mx-2"
                        htmlFor="pricePayment"
                      >
                        כניסה בתשלום
                      </label>
                    </div>
                    {errors.free && (
                      <div className="text-danger">*{errors.free.message}</div>
                    )}
                  </fieldset>
                </div>
              </div>
              ...
              <div className="d-flex flex-row align-items-center">
                <div
                  ...
                  className="form-outline flex-fill mb-0 border shadow p-3"
                >
                  <div className="prices">
                    ...
                    <input
                      {...studentOrSoldierPriceRef}
                      type="number"
                      id="form3Example3c"
                      className="form-control mb-2"
                    />
                    {errors.studentOrSoldier && (
                      <div className="text-danger">
                        המחיר יכול לנוע בין 0 ל10000
                      </div>
                    )}
              ...
              <fieldset className="mb-3">
                ...
                <div>
                  <input
                    ...
                    value="none"
                  />
                  <label className="form-check-label mx-2" htmlFor="none">
                    אין חנייה במקום{" "}
                  </label>
                </div>
                <div>
                  <input
                    ...
                    value="payment"
                  />
                  <label className="form-check-label mx-2" htmlFor="payment">
                    {" "}
                    חנייה בתשלום{" "}
                  </label>
                </div>
                {errors.parking && (
                  <div className="text-danger">*יש לסמן האם יש חנייה</div>
                )}
              </fieldset>

              {/* accessibility */}
              <p className="h5 mb-3">נגישות</p>
              <fieldset className="mb-3">
                <div>
                  <input
                    {...accessibilityRef}
                    className="form-check-input"
                    type="radio"
                    id="accessibilityTrue"
                    value={true}
                  />
                  <label
                    className="form-check-label mx-2"
                    htmlFor="accessibilityTrue"
                  >
                    {" "}
                    יש נגישות{" "}
                  </label>
                ...
                <div>
                  <input
                    ...
                    className="form-check-input"
                    type="radio"
                    id="accessibilityFalse"
                    value={false}
                  />
                  <label
                    className="form-check-label mx-2"
                    htmlFor="accessibilityFalse"
                  >
                    אין נגישות{" "}
                  </label>
                </div>
              ...
              <fieldset className="mb-3">
                ...
                <div>
                  ...
                  <label
                    className="form-check-label mx-2"
                    htmlFor="openEventFalse"
                  >
                    לא
                  </label>
                </div>
                {errors.open_event && (
                  <div className="text-danger">*יש לסמן האם האירוע פתוח</div>
                )}
              </fieldset>

              {/* place info */}
              <p className="h5 mb-3"> קצת על המקום:</p>
              <textarea {...placeInfoRef} className="form-control"></textarea>
              {errors.place_info && (
                <div className="text-danger"> יש למלא בין 2 ל500 תווים*</div>
              )}

              {/* trip details */}
              <p className="h5 my-3"> אז מה בתכנית:</p>
              <textarea {...tripDetailsRef} className="form-control" />
              {errors.trip_details && (
                <div className="text-danger"> יש למלא בין 2 ל1000 תווים*</div>
              )}
              ...
              {errors.during && (
                <div className="text-danger"> *{errors.during.message}</div>
              )}
              ...
              {/* required equipment */}
              <p className="h5 my-3"> האם יש צורך להביא ציוד מסויים לאירוע?</p>
              <fieldset className="mb-3">
                <div>
                  <input
                    onChange={() => {
                      setIsRequiredEquipment(false);
                    }}
                    name="requiredEquipment"
                    className="form-check-input"
                    type="radio"
                    id="requiredEquipmentFalse"
                  />
                  <label
                    className="form-check-label mx-2"
                    htmlFor="requiredEquipmentFalse"
                  >
                    לא
                  </label>
                </div>
                <div>
                  <input
                    onChange={() => {
                      setIsRequiredEquipment(true);
                    }}
                    name="requiredEquipment"
                    className="form-check-input"
                    type="radio"
                    id="requiredEquipmentTrue"
                  />
                  <label
                    className="form-check-label mx-2"
                    htmlFor="requiredEquipmentTrue"
                  >
                    {" "}
                    כן
                  </label>
              ...
              {isRequiredEquipment && (
                <div>
                  <p className="h6 mb-3"> פירוט הציוד שיש להביא:</p>
                  <textarea
                    {...requiredEquipmentRef}
