...
const SignUp = () => {
  ...
  const passRef = register("password", {
    required: true,
    minLength: 6,
    maxLength: 50,
  });
      ...
      <div className={`container ${styles.container}`}>
        <div className="row justify-content-center">
          <div
            ...
            style={{
              backgroundImage: `url(${require("../../images/roadLarge.jpg")})`,
          ...
          ></div>
          <div
            className={`col-11 col-md-7 p-4 p-sm-5 bg-white`}
          >
            ...
            <form onSubmit={handleSubmit(onSub)}>
                ...
                <div className="form-outline flex-fill mb-0">
                  ...
                  {errors.name && (
                    <div className="text-danger">
                      * השם צריך להיות בין 2 ל50 תווים
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                  ...
                  />
                  {errors.email && (
                    <div className="text-danger">* יש להכניס אימייל תקין</div>
                  )}
                </div>
              </div>
              ...
              <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                  ...
                  />
                  {errors.password && (
                    <div className="text-danger">* יש להכניס סיסמה תקינה</div>
                  )}
                </div>
              </div>
              ...
              <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                  ...
                  {errors.passwordAgain && (
                    <div className="text-danger">* סיסמאות לא תואמות</div>
                  )}
                </div>
              </div>
              ...
              <div className="d-flex flex-row align-items-center mb-4">
                <div className="form-outline flex-fill mb-0">
                  ...
                  {errors.gender && (
                    <div className="text-danger">* יש לבחור מין</div>
                  )}
                </div>
              </div>
              <div className="d-flex flex-column align-items-center justify-content-center mx-4 mb-3 mb-lg-4">
                <p className="mt-4">
                  {" "}
                  יש לך כבר חשבון? <Link to="/login">לחץ כאן</Link>
                </p>
                <button className="btn btn-warning btn-lg">רשום אותי</button>
              </div>
            </form>
          </div>
        </div>
